<template>
  <div class="brain-wrap" ref="brainwrap">
    <img src="/vue/assets/brain/dark/brain-bg.png" alt="" height="100%" class="img-bg">
    <img src="/vue/assets/brain/brain-wrap.png" usemap="#Map" id="imgMap" />
    <map name="Map" id="Map">
    ...
    <img src="/vue/assets/brain/line.png" alt="" class="brain-img line">
    <div v-if="!activeBrain&&!activeLabel">
      <img src="/vue/assets/brain/light/brain.png" alt="" class="brain-img" />
    </div>
    <div class="cerebral-cortex">
      <img v-show="activeBrain=='Cerebral cortex'&&activePart(null)" src="/vue/assets/brain/Cerebral cortex/Cerebral cortex（组1).png" alt="" class="brain-img">
      <img v-show="activePart('Cingulate cortex')" src="/vue/assets/brain/Cerebral cortex/Cingulate.png" alt="" class="brain-img">
      <img v-show="activePart('Frontal lobe')" src="/vue/assets/brain/Cerebral cortex/Frontal lobe.png" alt="" class="brain-img">
      <img v-show="activePart('Motor cortex')" src="/vue/assets/brain/Cerebral cortex/Motor Cortex.png" alt="" class="brain-img">
      <img v-show="activePart('Parietal lobe')" src="/vue/assets/brain/Cerebral cortex/Parietal lobe.png" alt="" class="brain-img">
      <img v-show="activePart('Occipital lobe')" src="/vue/assets/brain/Cerebral cortex/Occipital lobe.png" alt="" class="brain-img">
      <img v-show="activePart('Temporal lobe')" src="/vue/assets/brain/Cerebral cortex/Temporal lobe.png" alt="" class="brain-img">
      <img v-show="activePart('Prefrontal cortex')" src="/vue/assets/brain/Cerebral cortex/Prefrontal Cortex.png" alt="" class="brain-img">
      <img v-show="activePart('Somatosensory cortex')" src="/vue/assets/brain/Cerebral cortex/Somatosensory cortex.png" alt="" class="brain-img">
    </div>
    <div class="brainstem">
      <img v-show="activeBrain=='Brainstem'&&activePart(null)" src="/vue/assets/brain/Brainstem/Brainstem（组3）.png" alt="" class="brain-img">
      <img v-show="activePart('Medulla oblongata')" src="/vue/assets/brain/Brainstem/Medulla oblongata.png" alt="" class="brain-img">
      <img v-show="activePart('Midbrain')" src="/vue/assets/brain/Brainstem/Midbrain.png" alt="" class="brain-img">
      <img v-show="activePart('Pons')" src="/vue/assets/brain/Brainstem/Pones.png" alt="" class="brain-img">
    </div>
    <div class="Cerebellum" v-if="activeBrain=='Cerebellum'">
      <img src="/vue/assets/brain/cerebellum/Cerebellum（组2）.png" alt="" class="brain-img">
    </div>
    <div class="corpus" v-if="activeBrain=='Corpus callosum'">
      <img src="/vue/assets/brain/Corpus callosum/Corpus callosum（组6）.png" alt="" class="brain-img">
    </div>
    <div class="Deepstructures">
      <img v-show="activeBrain=='Limbic system'&&activePart(null)" src="/vue/assets/brain/deep structures/Deep structures（组4）.png" alt="" class="brain-img">
      <img v-show="activePart('Amygdala')" src="/vue/assets/brain/deep structures/Amygdala.png" alt="" class="brain-img">
      <img v-show="activePart('Basal ganglia')" src="/vue/assets/brain/deep structures/Basal ganglia.png" alt="" class="brain-img">
      <img v-show="activePart('Hippocampus')" src="/vue/assets/brain/deep structures/Hippocambus.png" alt="" class="brain-img">
      <img v-show="activePart('Hypothalamus')" src="/vue/assets/brain/deep structures/Hypothalamus.png" alt="" class="brain-img">
      <img v-show="activePart('Olfactory bulb')" src="/vue/assets/brain/deep structures/Olfactory bulb.png" alt="" class="brain-img">
      <img v-show="activePart('Pineal gland')" src="/vue/assets/brain/deep structures/Pineal gland.png" alt="" class="brain-img">
      <img v-show="activePart('Pituitary gland')" src="/vue/assets/brain/deep structures/Pituitary gland.png" alt="" class="brain-img">
      <img v-show="activePart('Putamen')" src="/vue/assets/brain/deep structures/putamen.png" alt="" class="brain-img">
      <img v-show="activePart('Thalamus')" src="/vue/assets/brain/deep structures/Thalamus.png" alt="" class="brain-img">
    </div>
    <div class="Spinal" v-if="activeBrain=='Spinal cord'">
      <img src="/vue/assets/brain/Spinal cord/Spinal cord（组5).png" alt="" class="brain-img">
    </div>
    <ul class="brain-nav">
